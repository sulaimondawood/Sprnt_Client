...
export const mockRiderTrips: Trip[] = [
  {
    ...
    driverId: 'driver-001',
    vehicleId: 'v-001',
    pickupLocation: { latitude: 6.5244, longitude: 3.3792, address: '123 Victoria Island, Lagos' },
    dropoffLocation: { latitude: 6.4541, longitude: 3.3947, address: '45 Lekki Phase 1, Lagos' },
  ...
  },
  {
    ...
    driverId: 'driver-002',
    vehicleId: 'v-002',
    pickupLocation: { latitude: 6.4541, longitude: 3.3947, address: '45 Lekki Phase 1, Lagos' },
    dropoffLocation: { latitude: 6.5095, longitude: 3.3711, address: 'Palms Shopping Mall, Lekki' },
    distanceMeters: 8200,
    estimatedFare: 3200,
    finalFare: 3500,
    status: 'COMPLETED',
  ...
  },
  {
    ...
    status: 'CANCELLED',
    pickupLocation: { latitude: 6.5244, longitude: 3.3792, address: '123 Victoria Island, Lagos' },
    dropoffLocation: { latitude: 6.4281, longitude: 3.4219, address: 'Ajah, Lagos' },
...
export const mockDriverTrips: Trip[] = [
  ...
  },
  {
    ...
    driverId: 'driver-001',
    vehicleId: 'v-001',
    pickupLocation: { latitude: 6.4281, longitude: 3.4219, address: 'Ajah, Lagos' },
    dropoffLocation: { latitude: 6.5095, longitude: 3.3711, address: 'Palms Shopping Mall, Lekki' },
  ...
  },
  {
    ...
    driverId: 'driver-001',
    vehicleId: 'v-001',
    pickupLocation: { latitude: 6.5095, longitude: 3.3711, address: 'Palms Shopping Mall, Lekki' },
    dropoffLocation: { latitude: 6.5244, longitude: 3.3792, address: '123 Victoria Island, Lagos' },
    distanceMeters: 9800,
    estimatedFare: 3800,
    status: 'STARTED',
    paymentStatus: 'PENDING',
...
export const mockSupportTickets: SupportTicket[] = [
  {
    ...
    description: 'The driver took a longer route than necessary which increased my fare.',
    status: 'IN_PROGRESS',
  ...
  },
  {
    ...
    description: 'I am trying to add my debit card but the app keeps showing an error.',
    status: 'RESOLVED',
