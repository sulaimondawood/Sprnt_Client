  ...
  const faqs = [
    {
      ...
      answer: 'You can cancel a ride from the trip details screen before the driver arrives. Note that cancellation fees may apply.',
    },
    {
      question: 'How are fares calculated?',
      answer: 'Fares are calculated based on distance, time, and current demand. You\'ll always see the estimated fare before booking.',
    },
    {
      question: 'What payment methods are accepted?',
      answer: 'We accept wallet payments, debit/credit cards, and cash payments.',
    },
    {
      question: 'How do I report a lost item?',
      answer: 'Contact support through this page or call our helpline. We\'ll help you connect with the driver.',
    },
  ];
