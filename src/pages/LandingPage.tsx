...
const LandingPage = () => {
  ...
  const features = [
    {
      ...
      description: 'Track your ride in real-time with our advanced GPS system and live ETA updates.',
    },
    {
      icon: Shield,
      title: 'Safe & Secure',
      description: 'Verified drivers, secure payments, emergency SOS, and 24/7 support.',
    },
    {
      icon: Zap,
      title: 'Instant Matching',
      description: 'Get matched with nearby drivers in seconds with our smart algorithm.',
    },
    {
      icon: CreditCard,
      title: 'Flexible Payments',
      description: 'Pay with cards, wallets, or cash. Split fares with friends easily.',
    },
  ];
  ...
  const testimonials = [
    {
      quote: "SPRNT has completely transformed my daily commute. It's reliable, affordable, and the drivers are always professional.",
      author: "Sarah Chen",
      role: "Marketing Executive",
      rating: 5
    },
    {
      quote: "As a driver, I love the flexibility. I can work whenever I want and the earnings are great. Best decision I've made!",
      author: "Michael Okonkwo",
      role: "SPRNT Driver",
      rating: 5
    },
    {
      quote: "The safety features give me peace of mind, especially for late-night rides. The SOS button is a game-changer.",
  ...
  const howItWorks = [
    { step: 1, title: 'Set Your Destination', description: 'Enter where you want to go and see fare estimates instantly' },
    { step: 2, title: 'Get Matched', description: 'Our algorithm finds the best driver near you in seconds' },
    { step: 3, title: 'Enjoy Your Ride', description: 'Track your ride in real-time and arrive safely' },
  ];
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden lg:flex items-center gap-10">
              {['Features', 'How It Works', 'Safety', 'Drive with us'].map((item) => (
                <Link 
                  key={item}
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              <Link to="/auth?signup=true">
                <Button size="lg" className="font-medium shadow-lg hover:shadow-xl transition-shadow bg-foreground text-background hover:bg-foreground/90">
                  Get Started
            ...
            >
              ...
              >
                <Link to="/auth?role=rider">
                  <Button size="lg" className="w-full sm:w-auto text-lg px-8 gap-3 h-14 shadow-2xl transition-all bg-primary text-primary-foreground hover:bg-primary/90">
                ...
                <Link to="/auth?role=driver">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto text-lg px-8 gap-3 h-14 bg-white/5 border-white/20 text-white hover:bg-white/10 hover:text-white">
              ...
              >
                ...
                <p className="text-white/50 text-sm">
                  <span className="text-white font-medium">10,000+</span> happy riders this week
                </p>
              </motion.div>
            </motion.div>
                ...
                <div className="relative p-8 space-y-6">
                  <div className="flex items-center gap-4 p-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-medium text-white">Victoria Island, Lagos</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                    ...
                    <div className="flex-1">
                      <p className="text-xs text-white/40 uppercase tracking-wide">Drop-off</p>
                  ...
                  <Button size="lg" className="w-full h-14 text-lg shadow-lg bg-foreground text-background hover:bg-foreground/90">
                    Book Now
          ...
          >
            {stats.map((stat) => (
              ...
              >
                ...
                <p className="text-4xl lg:text-5xl font-display font-semibold text-foreground">{stat.value}</p>
      ...
      <section id="how-it-works" className="py-24 bg-muted relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <span className="text-primary font-semibold text-sm uppercase tracking-widest">Simple & Easy</span>
              ...
              {howItWorks.map((item) => (
                ...
                >
                  <div className="flex-shrink-0 w-16 h-16 rounded-2xl gradient-primary flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                    <span className="text-2xl font-display font-semibold text-primary-foreground">{item.step}</span>
                  </div>
                  <div>
      ...
      <section id="features" className="py-24 relative">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">
              We've reimagined urban transportation with cutting-edge technology and uncompromising service.
            </p>
          </motion.div>
      ...
      <section className="py-24 gradient-hero relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <span className="text-primary font-semibold text-sm uppercase tracking-widest">Experience Excellence</span>
              <h2 className="text-3xl lg:text-5xl font-display font-semibold mt-4 mb-6">
                A Seamless Ride Experience
              </h2>
              <p className="text-white/60 text-lg mb-8 leading-relaxed font-light">
                Our app is designed with you in mind. Clean interface, intuitive controls, and powerful features that make every journey a pleasure.
              </p>
              ...
              <div className="flex gap-4 mt-10">
                <Button size="lg" className="gap-2 h-14 px-8 bg-primary text-primary-foreground hover:bg-primary/90">
                  <Play className="h-5 w-5" />
                  Watch Demo
                </Button>
                <Button size="lg" variant="outline" className="gap-2 h-14 px-8 bg-white/5 border-white/20 text-white hover:bg-white/10">
                  Learn More
                </Button>
              </div>
            </motion.div>
      ...
      <section className="py-24 bg-background relative">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">
              Join thousands of satisfied riders and drivers who trust SPRNT every day.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <span className="text-primary font-semibold text-sm uppercase tracking-widest">Global Reach</span>
              <h2 className="text-3xl lg:text-5xl font-display font-semibold mt-4 mb-6">
                Available in 100+ Cities Worldwide
              </h2>
              <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                From bustling metropolises to growing cities, SPRNT is expanding rapidly to bring premium transportation wherever you are.
              </p>

              <div className="flex flex-wrap gap-3 mb-8">
                {['Lagos', 'Abuja', 'Accra', 'Nairobi', 'Cairo', 'Cape Town', 'Johannesburg', 'Kigali'].map((city) => (
                  <span 
                    key={city}
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <span className="text-primary font-semibold text-sm uppercase tracking-widest">Join Our Team</span>
              <h2 className="text-3xl lg:text-5xl font-display font-semibold mt-4 mb-6">
            ...
            >
              {[
                ...
                { icon: CreditCard, title: 'Weekly Payouts', desc: 'Get paid fast' },
                { icon: Shield, title: 'Insurance Coverage', desc: 'Stay protected' },
            ...
            >
              <Link to="/auth?role=driver">
                <Button size="lg" className="gap-3 h-16 px-10 text-lg shadow-xl hover:shadow-2xl transition-all bg-foreground text-background hover:bg-foreground/90">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                <Button size="lg" variant="outline" className="h-16 px-8 bg-white text-foreground hover:bg-white/90 border-0 gap-3">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-2xl font-display font-semibold">SPRNT</span>
              </div>
            ...
            {[
              ...
              { title: 'Products', links: ['Ride', 'Drive', 'Business', 'Delivery'] },
              { title: 'Support', links: ['Help Center', 'Safety', 'Contact', 'FAQs'] },
            ].map((section) => (
              <div key={section.title}>
                <h4 className="font-display font-semibold mb-6">{section.title}</h4>
